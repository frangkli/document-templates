...
\usepackage{textcomp} % Better output font
...
\usepackage{setspace} % Help with complicated spacing
\usepackage{import} % Import files
\usepackage{pdfpages} % View PDF
\usepackage{transparent} % Allows transparency
\usepackage{xifthen} % If statement logic in latex
...
% Verticle line on left of proof
